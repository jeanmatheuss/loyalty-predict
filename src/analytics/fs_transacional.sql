...
share_produtos as (
    SELECT 
        ...
        1. * count(CASE WHEN DescNomeProduto = 'Lista de presença' THEN t1.IdTransacao END) AS qtdeListadepresenca,
        1. * count(CASE WHEN DescNomeProduto = 'Presença Streak' THEN t1.IdTransacao END) AS qtdePresencaStreak,
